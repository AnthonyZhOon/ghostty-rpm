...
%global iterm2_color_release_tag 20260216-151611-fc73ce3
...
Source34:       https://github.com/jacobsandlund/uucode/archive/refs/tags/v%{uucode_version2}.tar.gz
...
# Tests require Debug mode asserts to run
%{zig_test} %{build_flags} -Doptimize=Debug -Dapp-runtime=none
%endif
